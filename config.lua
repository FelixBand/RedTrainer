...
Config.VehiclesMenu = {
    ...
    { label = "Prison Wagon 01X", model = "WAGONPRISON01X" },
    ...
    { label = "Traveller's Wagon 01X", model = "wagonTraveller01x" },
    ...
    { label = "North Steamer 01X", model = "NORTHSTEAMER01X" },
    { label = "North Flatcar 01X", model = "northflatcar01x" },
    { label = "North Coalcar 01X", model = "northcoalcar01x" },
    ...
    { label = "Private Dining 01X", model = "PRIVATEDINING01X" },
    { label = "Private Armoured Car", model = "privatearmoured" },
    { label = "Private Armoured Car 03X", model = "armoredcar03x" },
    ...
    { label = "Private Steamer 01X", model = "PRIVATESTEAMER01X" },
    { label = "Winter Steamer", model = "WINTERSTEAMER" },
    { label = "Winter Coalcar", model = "wintercoalcar" },
    ...
    { label = "Steamer Ship GUAMA02", model = "SHIP_GUAMA02" },
    { label = "Steamer Ship NBD GUAMA", model = "SHIP_NBDGUAMA" },
    ...
    { label = "Hot Air Balloon", model = "HOTAIRBALLOON01" },
